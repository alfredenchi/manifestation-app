...
import { fetchRandomLionGlassVideo } from '../services/airtable';
...
const LionGlassUK = () => {
  ...
  const fetchInitialVideos = async () => {
    setLoading(true);
    try {
      const video = await fetchRandomLionGlassVideo();
      setVideos([video]);
    } catch (error) {
  ...
  const fetchNextVideo = async () => {
    ...
    setLoading(true);
    try {
      const nextVideo = await fetchRandomLionGlassVideo();
